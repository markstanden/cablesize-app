...
export namespace SWA70 {
   ...
   export const ccc_refC_SP: CurrentCarryingCapacity = {
      1.5: 21,
      2.5: 28,
      4: 38,
      6: 49,
   ...
   export const ccc_refC_TP: CurrentCarryingCapacity = {
      1.5: 18,
      2.5: 25,
      4: 33,
      6: 42,
   ...
   export const ccc_refE_SP: CurrentCarryingCapacity = {
      1.5: 22,
      2.5: 31,
      4: 41,
      6: 53,
   ...
   export const ccc_refE_TP: CurrentCarryingCapacity = {
      1.5: 19,
      2.5: 26,
      4: 35,
      6: 45,
   ...
   export const ccc_refD_SP: CurrentCarryingCapacity = {
      1.5: 22,
      2.5: 29,
      4: 37,
      6: 46,
   ...
   export const ccc_refD_TP: CurrentCarryingCapacity = {
      1.5: 18,
      2.5: 24,
      4: 30,
      6: 38,
